---
name: algevb_perturb-v4
description: Perturber policy algevb_perturb-v4 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algevb_perturb-v4 (math mode)
...
- **algevb_perturb-v4** — evolved from round 2: 3 edits {'replace_in_rule': 1, 'add_rule': 2}
