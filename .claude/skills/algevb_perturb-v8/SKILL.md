---
name: algevb_perturb-v8
description: Perturber policy algevb_perturb-v8 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algevb_perturb-v8 (math mode)
...
- **algevb_perturb-v8** — evolved from round 6: 2 edits {'replace_in_rule': 1, 'add_rule': 1}
