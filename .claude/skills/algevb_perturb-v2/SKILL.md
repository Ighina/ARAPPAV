---
name: algevb_perturb-v2
description: Perturber policy algevb_perturb-v2 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algevb_perturb-v2 (math mode)
...
- **algevb_perturb-v2** — evolved from round 0: 5 edits {'add_rule': 5}
