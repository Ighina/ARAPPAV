---
name: algev_perturb-v6
description: Perturber policy algev_perturb-v6 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algev_perturb-v6 (math mode)
...
- **algev_perturb-v6** — evolved from round 4: 4 edits {'append_to_rule': 3, 'replace_in_rule': 1}
