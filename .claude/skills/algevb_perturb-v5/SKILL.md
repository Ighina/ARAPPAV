---
name: algevb_perturb-v5
description: Perturber policy algevb_perturb-v5 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algevb_perturb-v5 (math mode)
...
- **algevb_perturb-v5** — evolved from round 3: 2 edits {'append_to_rule': 1, 'add_rule': 1}
