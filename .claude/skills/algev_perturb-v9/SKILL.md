---
name: algev_perturb-v9
description: Perturber policy algev_perturb-v9 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algev_perturb-v9 (math mode)
...
- **algev_perturb-v9** — evolve produced no admissible patch; carried v8
