---
name: algev_perturb-v8
description: Perturber policy algev_perturb-v8 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algev_perturb-v8 (math mode)
...
- **algev_perturb-v8** — evolve produced no admissible patch; carried v7
