---
name: hverify-v1
description: Verifier policy hverify-v1 (math mode) — find every genuine error in a possibly-perturbed math solution and emit ARAPPAV claim JSON with exact quoted spans. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Verifier — hverify-v1 (math mode)
...
- **hverify-v1** — cold start — empty policy
