---
name: hperturb-v1
description: Perturber policy hperturb-v1 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — hperturb-v1 (math mode)
...
- **hperturb-v1** — cold start — empty policy
