---
name: algevb_verify-v4
description: Verifier policy algevb_verify-v4 (math mode) — find every genuine error in a possibly-perturbed math solution and emit ARAPPAV claim JSON with exact quoted spans. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Verifier — algevb_verify-v4 (math mode)
...
- **algevb_verify-v4** — evolve produced no admissible patch; carried v3
