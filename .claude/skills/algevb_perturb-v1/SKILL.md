---
name: algevb_perturb-v1
description: Perturber policy algevb_perturb-v1 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algevb_perturb-v1 (math mode)
...
- **algevb_perturb-v1** — cold start — empty policy
