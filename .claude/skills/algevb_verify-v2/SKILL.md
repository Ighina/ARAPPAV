---
name: algevb_verify-v2
description: Verifier policy algevb_verify-v2 (math mode) — find every genuine error in a possibly-perturbed math solution and emit ARAPPAV claim JSON with exact quoted spans. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Verifier — algevb_verify-v2 (math mode)
...
- **algevb_verify-v2** — evolved from round 0: 5 edits {'add_rule': 5}
