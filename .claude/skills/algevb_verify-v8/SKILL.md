---
name: algevb_verify-v8
description: Verifier policy algevb_verify-v8 (math mode) — find every genuine error in a possibly-perturbed math solution and emit ARAPPAV claim JSON with exact quoted spans. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Verifier — algevb_verify-v8 (math mode)
...
- **algevb_verify-v8** — evolved from round 6: 5 edits {'add_rule': 4, 'append_to_rule': 1}
