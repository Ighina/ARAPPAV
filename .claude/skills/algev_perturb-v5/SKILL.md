---
name: algev_perturb-v5
description: Perturber policy algev_perturb-v5 (math mode) — inject exactly k realistic, independent misconception errors into the SOLUTION of a math problem and emit the ARAPPAV ground-truth JSON. Invoked by the deterministic pipeline orchestrator with inputs inline.
---

# Perturber — algev_perturb-v5 (math mode)
...
- **algev_perturb-v5** — evolve produced no admissible patch; carried v4
